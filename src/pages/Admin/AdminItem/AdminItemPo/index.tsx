...
export const AdminItemPo = () => {
  ...
  const data1: any = {
    ...
    categories: null,
    categoryName: '해양사고예방',
    createDate: '2022-11-13T23:24:19.801986',
    lastModifiedDate: '2022-11-13T23:24:19.801986',
  };
  ...
  const [enteredNum, setEnterdNum] = useState({
    moneyNum: MoneyNumber2(data1.price),
    quantityNum: MoneyNumber2(data1.quantity),
  });
  ...
  //카테고리 select
  const [cataSelect, setCataSelect] = useState(data1.categoryName);
  const selectChange = (e: any) => {
    setCataSelect(e.target.value);
  };

  // 상품명 useState
  const [itemName, setItemName] = useState(data1.name);
    ...
    <div>
      ...
      <S.Container>
        ...
        <S.Wrapper>
          ...
          <S.QnABox>
            <S.QnAButton onClick={() => navigate('/admin-item')}>수정</S.QnAButton>
